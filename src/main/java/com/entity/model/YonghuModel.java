...
public class YonghuModel  implements Serializable {
	...
	private Integer youzhengbianhao;
	...
	public void setYouzhengbianhao(Integer youzhengbianhao) {
		this.youzhengbianhao = youzhengbianhao;
	}
	
	/**
	 * 获取：邮政编号
	 */
	public Integer getYouzhengbianhao() {
		return youzhengbianhao;
	}
