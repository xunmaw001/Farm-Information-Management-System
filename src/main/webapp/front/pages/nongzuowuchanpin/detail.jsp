				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>农作物编号：</span>
							<span class="desc">
								{{detail.nongzuowubianhao}}
							</span>
						</div>
																								<div class="detail-item">
							<span>农作物名称：</span>
							<span class="desc">
								{{detail.nongzuowumingcheng}}
							</span>
						</div>
																																										<div class="detail-item">
							<span>负责人：</span>
							...
							<span>种植时间：</span>
							<span class="desc">
								{{detail.zhongzhishijian}}
							</span>
						</div>
																								<div class="detail-item">
							<span>生产环境数据：</span>
							<span class="desc">
								{{detail.shengchanhuanjingshuju}}
							</span>
						</div>
																								<div class="detail-item">
							<span>预计采收时间：</span>
							<span class="desc">
								{{detail.yujicaishoushijian}}
							</span>
						</div>
																								<div class="detail-item">
							<span>预计产量：</span>
							<span class="desc">
								{{detail.yujichanliang}}
							</span>
						</div>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div class="layui-tab-content">
								...
								<div v-html="detail.xiangqingbeizhu"></div>
							</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`nongzuowuchanpin`);
