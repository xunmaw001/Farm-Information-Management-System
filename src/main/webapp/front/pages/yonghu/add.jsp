		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.youzhengbianhao" type="text" name="youzhengbianhao" id="youzhengbianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                					                                        ...
                                                                                					                                        if(!isIntNumer(data.youzhengbianhao)){
                        layer.msg('邮政编号应输入整数', {
							time: 2000,
							icon: 5
						});
