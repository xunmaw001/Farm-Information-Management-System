				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>商品收入：</span>
							<span class="desc">
								{{detail.shangpinshouru}}
							</span>
						</div>
																								<div class="detail-item">
							<span>收入事项：</span>
							<span class="desc">
								{{detail.shourushixiang}}
							</span>
						</div>
																								<div class="detail-item">
							<span>收入金额：</span>
							...
							<span>传感器维护：</span>
							<span class="desc">
								{{detail.chuanganqiweihu}}
							</span>
						</div>
																								<div class="detail-item">
							<span>支出事项：</span>
							<span class="desc">
								{{detail.zhichushixiang}}
							</span>
						</div>
																								<div class="detail-item">
							<span>支出金额：</span>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`zijintongji`);
