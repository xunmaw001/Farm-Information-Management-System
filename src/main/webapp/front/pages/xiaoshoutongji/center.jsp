				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="kehuxingming" id="kehuxingming">
									<option value="">请选择</option>
							...
							<div class="layui-input-block">
								<input type="text" name="xiaoshoushuliang" id="xiaoshoushuliang" placeholder="销售数量" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">销售价格</label>
							<div class="layui-input-block">
								<input type="text" name="xiaoshoujiage" id="xiaoshoujiage" placeholder="销售价格" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">销售日期</label>
							<div class="layui-input-block">
								<input type="text" name="xiaoshouriqi" id="xiaoshouriqi" placeholder="销售日期" autocomplete="off" class="layui-input">
							</div>
						</div>
