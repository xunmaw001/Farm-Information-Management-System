...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">农资信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active">农资信息列表</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">农资信息列表</h3>							
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																									<label>
												类别
												<select name="leibie" id="leibieSelect" class="form-control form-control-sm" aria-controls="tableId">
																											<option value=" "> </option>
											...
											<th class="no-sort" style="min-width: 35px;">
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('leibie')">类别<i id="leibieIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
													var leibieIndex = document.getElementById("leibieSelect").selectedIndex;
				var leibieOptions = document.getElementById("leibieSelect").options;
				var leibieSelectedOption = leibieOptions[leibieIndex]
				if(leibieSelectedOption.text != null && leibieSelectedOption.text != ''){
					searchForm.leibie = "%" + leibieSelectedOption.text + "%";
				}
        ...
        function getDataList() {
			http("nongzixinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
																						leibie : searchForm.leibie,	
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
							...
							var leibieCell  = document.createElement('td');

												  leibieCell.innerHTML = item.leibie; 
                
									row.appendChild(leibieCell);
				  ...
				  tupianCell.appendChild(tupianImg);
									...
									row.appendChild(tupianCell);
				            				var guigeCell  = document.createElement('td');
												  ...
												  if(item.guige != null && item.guige != "" && item.guige.length >= 11){
				  	guigeCell.innerHTML = item.guige.substring(0, 10) + "..."; 
				  }else{
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("nongzixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"nongzixinxi");
