		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑农资信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item">农资信息管理</li>
								<li class="breadcrumb-item active">编辑农资信息</li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">农资信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										<div class="form-group col-md-6">
										<label>类别</label>
										<select id="leibieSelect" name="leibie" class="form-control">
																						<option value=" "></option>
																																					<option class="leibieOption" value="农作物">
														农作物
													</option>
																										<option class="leibieOption" value="化肥">
														化肥
													</option>
																										<option class="leibieOption" value="农药">
														农药
													</option>
																										<option class="leibieOption" value="农具">
														农具
													</option>
																										<option class="leibieOption" value="农机">
														农机
													</option>
																										<option class="leibieOption" value="传感器">
														传感器
													</option>
																																			</select>	
									</div>	
										...
										<input name="tupian" id="tupian-input" type="hidden">
											...
											<div class="form-group col-md-6">
										<label>规格</label>
										<textarea name="guige" class="form-control" id="guige" rows="3"></textarea>
									</div>
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "nongzixinxi/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("nongzixinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("nongzixinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												var leibieOptions = document.getElementsByClassName("leibieOption");
					for(var leibieCount = 0; leibieCount < leibieOptions.length;leibieCount++){
						if(leibieOptions[leibieCount].getAttribute('value') == ruleForm.leibie){
							leibieOptions[leibieCount].setAttribute('selected','selected');
						}
					}
																...
																$("#guige-input").val(ruleForm.guige);
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												if(res.data != null && res.data != '' && res.data.leibie != null && res.data.leibie != ''){

															var leibieOptions = document.getElementsByClassName("leibieOption");
								for(var leibieCount = 0; leibieCount < leibieOptions.length;leibieCount++){
									if(leibieOptions[leibieCount].getAttribute('value') == res.data.leibie){
										leibieOptions[leibieCount].setAttribute('selected','selected');
									}
								}
													}
								...
								$("#tupian-input").val(res.data.tupian);
												...
												if(res.data != null && res.data != '' && res.data.guige != null && res.data.guige != ''){
															...
															$("#guige-input").val(res.data.guige);
													}
