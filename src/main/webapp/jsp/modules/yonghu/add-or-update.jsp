								...
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<input id="shenfenzhenghao" name="shenfenzhenghao" class="form-control" placeholder="身份证号">
											...
											<div class="form-group col-md-6">
										<label>邮政编号</label>
										<input id="youzhengbianhao" name="youzhengbianhao" class="form-control" placeholder="邮政编号">
									</div>
											<div class="form-group col-md-6">
										<label>收货地址</label>
					...
					for(var xingbieCount = 0; xingbieCount < xingbieOptions.length;xingbieCount++){
						if(xingbieOptions[xingbieCount].getAttribute('value') == ruleForm.xingbie){
							xingbieOptions[xingbieCount].setAttribute('selected','selected');
																...
																$("#youzhengbianhao").val(ruleForm.youzhengbianhao);	
								...
								for(var xingbieCount = 0; xingbieCount < xingbieOptions.length;xingbieCount++){
									if(xingbieOptions[xingbieCount].getAttribute('value') == res.data.xingbie){
										xingbieOptions[xingbieCount].setAttribute('selected','selected');
												...
												if(res.data != null && res.data != '' && res.data.youzhengbianhao != null && res.data.youzhengbianhao != ''){

															$("#youzhengbianhao").val(res.data.youzhengbianhao);
													}
