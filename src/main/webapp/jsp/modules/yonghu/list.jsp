												...
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('yonghuming')">用户名<i id="yonghumingIcon" class="fa fa-sort"></i></th>
																																																			...
																																																			<th onclick="sort('youzhengbianhao')">邮政编号<i id="youzhengbianhaoIcon" class="fa fa-sort"></i></th>
			...
			row.appendChild(checkbox)
							...
							var yonghumingCell  = document.createElement('td');
									...
									row.appendChild(shenfenzhenghaoCell);
				            				var youzhengbianhaoCell  = document.createElement('td');

												 youzhengbianhaoCell.innerHTML = item.youzhengbianhao;

				
									row.appendChild(youzhengbianhaoCell);
