							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
										...
										<label>员工账号</label>
										<input id="yuangongzhanghao" name="yuangongzhanghao" class="form-control" placeholder="员工账号">
									</div>
											<div class="form-group col-md-6">
										<label>密码</label>
										...
										<select id="zhiweiSelect" name="zhiwei" class="form-control">
																						<option value=" "></option>
																																					<option class="zhiweiOption" value="文员">
														文员
													</option>
																										<option class="zhiweiOption" value="职员">
														职员
													</option>
																										<option class="zhiweiOption" value="技术员">
														技术员
													</option>
																										<option class="zhiweiOption" value="农艺员">
														农艺员
													</option>
																										<option class="zhiweiOption" value="主管">
														主管
													</option>
																										<option class="zhiweiOption" value="经理">
														经理
													</option>
																																			</select>	
									</div>	
	...
	<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js/datetimepicker/bootstrap-datetimepicker.min.js"></script>
		...
		function dataBind(){
			$("#updateId").val(ruleForm.id);	
												$("#yuangongzhanghao").val(ruleForm.yuangongzhanghao);	
				...
				http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
					if(res.code == 0){
						...
						$('#updateId').val(crossTableId);
												if(res.data != null && res.data != '' && res.data.yuangongzhanghao != null && res.data.yuangongzhanghao != ''){

															$("#yuangongzhanghao").val(res.data.yuangongzhanghao);
													}
