...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3">
								<div class="col-sm-12">
																																									<label>
												员工账号
												<input type="text" id="yuangongzhanghaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
											</label>
																																																																																																																																										<label>
												部门
											...
											<th class="no-sort" style="min-width: 35px;">
												<div class="custom-control custom-checkbox">
													...
													<label class="custom-control-label" for="select-all"></label>
																																						...
																																						<th onclick="sort('yuangongzhanghao')">员工账号<i id="yuangongzhanghaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
													if($('#yuangongzhanghaoSearch').val() != null && $('#yuangongzhanghaoSearch').val() != ''){
					searchForm.yuangongzhanghao ="%" +  $('#yuangongzhanghaoSearch').val() + "%";
				}
        ...
        function getDataList() {
			http("yuangong/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
																						yuangongzhanghao : searchForm.yuangongzhanghao,	
		...
		function setDataRow(item,number){
			...
			row.appendChild(checkbox)
							...
							var yuangongzhanghaoCell  = document.createElement('td');

												 yuangongzhanghaoCell.innerHTML = item.yuangongzhanghao;

				
									row.appendChild(yuangongzhanghaoCell);
		...
		function detail(id){
			...
			window.location.href = "info.jsp";
					...
					//填充下拉框选项
					http("option/bumenxinxi/bumenmingcheng","GET",{},(res)=>{
						if(res.code == 0){
